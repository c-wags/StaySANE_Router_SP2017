...
/**
 * Name: GetIPAddress Class
 *
 * Description: This is to provide a generic methods to get the IP address of a URL name. The main
 * method in this class takes care of spinning off the thread to ask the nameserver for a conversion.
 */
