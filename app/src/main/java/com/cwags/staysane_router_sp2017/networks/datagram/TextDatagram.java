 ...
 * Name: TextDatagram
 *
 * Description: This is a datagram which is used for testing. It will contain
 */

public class TextDatagram implements Datagram {

    private String payloadText; //This is the text that this datagram will use to represent a payload
    ...
    public String toHexString() {
        return Utilities.convertToHexString(payloadText);
    }
